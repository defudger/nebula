...
errc socket::connect(const endpoint &ep)
{
    ...
    ::sockaddr_storage strg_;
    ::sockaddr &addr = *reinterpret_cast<::sockaddr *>(&strg_);
...
expect<socket, errc> socket::accept(endpoint &ep)
{
    ...
    ::sockaddr_storage strg_;
    ::sockaddr &addr = *reinterpret_cast<::sockaddr *>(&strg_);
    ::socklen_t n = sizeof(::sockaddr_storage);
    ...
    const size_t n)
{
    ...
    ::sockaddr_storage strg_;
    ::sockaddr &addr = *reinterpret_cast<::sockaddr *>(&strg_);
    ::socklen_t sn = sizeof(::sockaddr_storage);
