...
/** */
template <class R__>
class reversed_range : public adaptor_base<R__>
{
    using R = typename adaptor_base<R__>::adaptee_type;
...
public:
    ...
    : adaptor_base<R__>(foundation::forward<R_>(r))
    {}
...
//------------------------------------------------------------------------------
inline constexpr reversed_range_detail::reversed_range_trigger
reverse() noexcept
{
    return reversed_range_detail::reversed_range_trigger();
}
