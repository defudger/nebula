...
/** */
template <class R__>
class stridden_range : public adaptor_base<R__>
{
...
public:
    ...
    : adaptor_base<R__>(foundation::forward<R_>(r)), step(step_)
    {
        n_assert(step_ > 0);
    }
...
//------------------------------------------------------------------------------
template <class N>
inline stridden_range_detail::stridden_range_trigger<N> stride(N x) noexcept
{
