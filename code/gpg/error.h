...
//------------------------------------------------------------------------------
n_register_error_code_enum(::nebula::gpg::detail::errc,
    ::nebula::gpg::detail::gpg_error_category());
n_register_error_condition_enum(::nebula::gpg::detail::errc,
    ::nebula::gpg::detail::gpg_error_category());
